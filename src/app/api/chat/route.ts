...
const AGENT_PERSONAS: Record<string, { name: string; role: string; personality: string; focus: string }> = {
  TANYA: { name: 'TANYA™', role: 'Chief Sales Strategist at Zenith Intelligence', personality: 'Sharp, warm, direct, like a brilliant co-founder.', focus: 'sales strategy, lead qualification, pitches, follow-ups, pipeline, conversions' },
...
Zenith Intelligence is the umbrella company. FINPAL™ is the accounting/bookkeeping sub-brand (R350/month). SalesPAL is the sales CRM. Digital Products: $37–$47 bundle / $27 individual. FINPAL™ SalesOS: $29–$299/month. Consulting: Custom pricing.
